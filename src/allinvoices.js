            ...
            <table class="table table-striped">
                ...
                {this.state.item.map((item) => <tr key={item.id}>  
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-secondary btn-sm" data-toggle="modal" data-target="#viewModal" onClick={()=>this.modalOnClick(item.invoiceID)} >
                                View
                    </button>

                    </td>
                    <td>
                    <button type="button" className="btn btn-info btn-sm" disabled={this.Bstatus(item.assignstatus)} onClick={() =>this.viewDeliverer(item.invoiceID)}>
                        {item.assignstatus}
                        </button> 
